...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="h-screen flex font-sans bg-gray-50 p-4 gap-4">
      {/* Sidebar */}
      <div className="w-1/3 bg-white rounded-xl shadow-md flex flex-col">
        <div className="p-4 border-b border-slate-200 font-semibold text-slate-700 rounded-t-xl bg-slate-400">
          Chats
        </div>
        ...
        <div className="p-3">
          <input 
              type="text" 
              className="w-full px-3 py-2 border border-slate-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-300 text-sm" 
        ...
        <div className="flex-1 overflow-y-auto px-3 pb-3">
          <ul className="space-y-2">
            {chatsFiltrados.map((chat) => (
              <li
                key={chat.id}
                className="p-3 bg-slate-100 rounded-lg shadow-sm hover:shadow-md hover:bg-blue-50 cursor-pointer transition-all"
      ...
      {/* Conversación */}
      <div className="w-2/3 bg-white rounded-xl shadow-md flex flex-col">
        {chatSeleccionado ? (
          <>
            <div className="p-4 border-b border-slate-200 font-semibold text-slate-700 rounded-t-xl bg-slate-400 shadow-sm">
